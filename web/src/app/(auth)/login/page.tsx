      ...
      <div className="flex w-full lg:w-1/2 flex-col items-center justify-center px-6 py-12 sm:px-12">
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-slate-500">Sign in to your Floqi account</p>
          </div>
        ...
        <div className="max-w-md text-center text-white">
          ...
          <div className="mt-10 space-y-3 text-sm text-blue-200">
            <div className="flex items-center gap-2">
              ...
              Morning Briefing — daily summary delivered
            </div>
            <div className="flex items-center gap-2">
              <span className="text-blue-300">✦</span>
              Email Triage — inbox organized automatically
            </div>
            <div className="flex items-center gap-2">
              <span className="text-blue-300">✦</span>
              Reading Digest — news tailored to you
            </div>
          </div>
        </div>
      </div>
