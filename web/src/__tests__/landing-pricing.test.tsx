 ...
 * Server Component pattern: await LandingPage() → render(jsx)
 */
...
describe("TC-9006: 랜딩 페이지 Pricing 섹션", () => {
  it("TC-9006: 랜딩 페이지에 'Pricing' 섹션 제목이 있다", async () => {
  ...
  it("TC-9006: Free 플랜 카드가 표시된다", async () => {
    const jsx = await LandingPage();
    render(jsx);
  ...
  it("TC-9006: Pro 플랜 카드가 표시된다", async () => {
    const jsx = await LandingPage();
    render(jsx);
  ...
  it("TC-9006: BYOK 플랜 카드가 표시된다", async () => {
    const jsx = await LandingPage();
    render(jsx);
  ...
  it("TC-9006: 3개 플랜 카드가 모두 표시된다", async () => {
    const jsx = await LandingPage();
    render(jsx);
  ...
  it("TC-9006: Pricing 섹션에 data-testid='pricing-section'이 있다", async () => {
    const jsx = await LandingPage();
    render(jsx);
  ...
  it("TC-9006: Free 플랜에 30 executions/month 제한이 표시된다", async () => {
    const jsx = await LandingPage();
    render(jsx);
  ...
  it("TC-9006: Pro 플랜에 500 executions/month 제한이 표시된다", async () => {
    const jsx = await LandingPage();
    render(jsx);
